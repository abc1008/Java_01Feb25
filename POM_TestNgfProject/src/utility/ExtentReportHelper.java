...
public class ExtentReportHelper
{
	...
	public ExtentReportHelper(WebDriver driver)
	{
		this.driver = driver;
		extentReports = new ExtentReports();
		String reportPath = "D:\\TRAININGS\\Selenium_JAVA_01FEB25_WEEKDAY_MORNING\\Reports\\TestReport_"+BaseClass.dateTimeStamp+".html";
